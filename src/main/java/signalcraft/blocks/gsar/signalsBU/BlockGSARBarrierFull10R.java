...
import signalcraft.entities.gsar.signalsBU.TileGSARFullBarriersx10R;


public class BlockGSARBarrierFull10R extends BlockLevelCrossing
{

    public BlockGSARBarrierFull10R(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARFullBarriersx10R();
    }
}
