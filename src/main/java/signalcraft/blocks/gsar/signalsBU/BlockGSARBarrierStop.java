...
import signalcraft.entities.gsar.signalsBU.TileGSARBarrierStop;


public class BlockGSARBarrierStop extends BlockSignSignal
{

    public BlockGSARBarrierStop(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARBarrierStop();
    }
}
