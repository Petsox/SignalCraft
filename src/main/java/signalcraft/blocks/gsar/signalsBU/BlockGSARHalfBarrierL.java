...
import signalcraft.entities.gsar.signalsBU.TileGSARHalfBarrierL;


public class BlockGSARHalfBarrierL extends BlockLevelCrossing
{

    public BlockGSARHalfBarrierL(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARHalfBarrierL();
    }
}
