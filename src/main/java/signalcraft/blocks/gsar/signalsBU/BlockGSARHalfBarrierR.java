...
import signalcraft.entities.gsar.signalsBU.TileGSARHalfBarrierR;


public class BlockGSARHalfBarrierR extends BlockLevelCrossing
{

    public BlockGSARHalfBarrierR(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARHalfBarrierR();
    }
}
