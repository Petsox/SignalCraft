...
import signalcraft.entities.gsar.signalsBU.TileGSARRailCrossFence;


public class BlockGSARRailCrossFence extends BlockSignSignal
{

    public BlockGSARRailCrossFence(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARRailCrossFence();
    }
}
