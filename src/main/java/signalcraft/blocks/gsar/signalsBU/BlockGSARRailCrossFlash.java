...
import signalcraft.entities.gsar.signalsBU.TileGSARRailCrossFlash;


public class BlockGSARRailCrossFlash extends BlockSignSignal
{

    public BlockGSARRailCrossFlash(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARRailCrossFlash();
    }
}
