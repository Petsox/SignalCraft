...
import signalcraft.entities.gsar.signalsBU.TileGSARSignalBU5;


public class BlockGSARSignalBU5 extends BlockSignSignal
{

    public BlockGSARSignalBU5(String name) {
        super(name);
