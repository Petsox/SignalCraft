...
import signalcraft.entities.gsar.signalsBU.TileGSARSignalPF2;
...
public class BlockGSARSignalPF2 extends BlockSignSignal
{

    public BlockGSARSignalPF2(String name) {
        super(name);
