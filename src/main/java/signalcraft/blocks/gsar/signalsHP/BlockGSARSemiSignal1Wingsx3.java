...
public class BlockGSARSemiSignal1Wingsx3 extends BlockGSARSemiSignals
{
    public BlockGSARSemiSignal1Wingsx3(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int metaData) {
        return new TileGSARSemiSignal1Wingsx3();
    }
}
