...
public class BlockGSARSemiSignal2Wingsx3 extends BlockGSARSemiSignals
{
    public BlockGSARSemiSignal2Wingsx3(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int metaData) {
        return new TileGSARSemiSignal2Wingsx3();
    }
}
