...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE1;


public class BlockGSARSignalNE1 extends BlockSignSignal
{

    public BlockGSARSignalNE1(String name) {
        super(name);
