...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE3_2;

public class BlockGSARSignalNE3_2 extends BlockSignSignal
{

    public BlockGSARSignalNE3_2(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARSignalNE3_2();
    }
}
