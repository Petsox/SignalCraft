...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE3_3;

public class BlockGSARSignalNE3_3 extends BlockSignSignal
{

    public BlockGSARSignalNE3_3(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARSignalNE3_3();
    }
}
