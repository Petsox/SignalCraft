...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE4;

public class BlockGSARSignalNE4 extends BlockSignSignal
{

    public BlockGSARSignalNE4(String name) {
        super(name);
