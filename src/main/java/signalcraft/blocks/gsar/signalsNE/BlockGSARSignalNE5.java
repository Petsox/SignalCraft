...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE5;

public class BlockGSARSignalNE5 extends BlockSignSignal
{

    public BlockGSARSignalNE5(String name) {
        super(name);
