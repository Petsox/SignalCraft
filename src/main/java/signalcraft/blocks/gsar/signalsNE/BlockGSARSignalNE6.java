...
import signalcraft.entities.gsar.signalsNE.TileGSARSignalNE6;

public class BlockGSARSignalNE6 extends BlockSignSignal
{

    public BlockGSARSignalNE6(String name) {
        super(name);
