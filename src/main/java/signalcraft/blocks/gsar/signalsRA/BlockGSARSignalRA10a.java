...
import signalcraft.entities.gsar.signalsRA.TileGSARSignalRA10a;


public class BlockGSARSignalRA10a extends BlockSignSignal
{

    public BlockGSARSignalRA10a(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARSignalRA10a();
    }
}
