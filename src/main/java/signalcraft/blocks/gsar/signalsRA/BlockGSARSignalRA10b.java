...
import signalcraft.entities.gsar.signalsRA.TileGSARSignalRA10b;


public class BlockGSARSignalRA10b extends BlockSignSignal
{

    public BlockGSARSignalRA10b(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(final World world, final int par2) {
        return new TileGSARSignalRA10b();
    }
}
