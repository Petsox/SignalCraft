package signalcraft.blocks.signals.lightSignals;
...
public abstract class BlockLightSignal extends BlockContainer implements ISCBlock {
    public BlockLightSignal(String name) {
        super(Material.iron);
