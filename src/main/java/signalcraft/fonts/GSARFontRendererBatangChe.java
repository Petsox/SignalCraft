...
public class GSARFontRendererBatangChe extends GSARFontRenderer
{
    ...
    public GSARFontRendererBatangChe(final GameSettings par1GameSettings, final ResourceLocation par2ResourceLocation, final TextureManager par3TextureManager, final boolean unicode) {
    ...
    public ResourceLocation getUnicodePageLocation(final int par1) {
        if (GSARFontRendererBatangChe.unicodePageLocations[par1] == null) {
            GSARFontRendererBatangChe.unicodePageLocations[par1] = new ResourceLocation(String.format("signalcraft:fonts/batang_che_unicode_page_00.png", par1));
        }
        return GSARFontRendererBatangChe.unicodePageLocations[par1];
    }
