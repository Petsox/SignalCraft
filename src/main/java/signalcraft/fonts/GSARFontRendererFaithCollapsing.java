...
public class GSARFontRendererFaithCollapsing extends GSARFontRenderer
{
    ...
    public GSARFontRendererFaithCollapsing(final GameSettings par1GameSettings, final ResourceLocation par2ResourceLocation, final TextureManager par3TextureManager, final boolean unicode) {
    ...
    public ResourceLocation getUnicodePageLocation(final int par1) {
        if (GSARFontRendererFaithCollapsing.unicodePageLocations[par1] == null) {
            GSARFontRendererFaithCollapsing.unicodePageLocations[par1] = new ResourceLocation(String.format("signalcraft:fonts/faith_collapsing_unicode_page_00.png", par1));
        }
        return GSARFontRendererFaithCollapsing.unicodePageLocations[par1];
    }
