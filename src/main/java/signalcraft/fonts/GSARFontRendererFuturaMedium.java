...
public class GSARFontRendererFuturaMedium extends GSARFontRenderer
{
    ...
    public GSARFontRendererFuturaMedium(final GameSettings par1GameSettings, final ResourceLocation par2ResourceLocation, final TextureManager par3TextureManager, final boolean unicode) {
    ...
    public ResourceLocation getUnicodePageLocation(final int par1) {
        if (GSARFontRendererFuturaMedium.unicodePageLocations[par1] == null) {
            GSARFontRendererFuturaMedium.unicodePageLocations[par1] = new ResourceLocation(String.format("signalcraft:fonts/futura_medium.png", par1));
        }
        return GSARFontRendererFuturaMedium.unicodePageLocations[par1];
    }
