...
public class GSARFontRendererGlasgow extends GSARFontRenderer
{
    ...
    public GSARFontRendererGlasgow(final GameSettings par1GameSettings, final ResourceLocation par2ResourceLocation, final TextureManager par3TextureManager, final boolean unicode) {
    ...
    public ResourceLocation getUnicodePageLocation(final int par1) {
        if (GSARFontRendererGlasgow.unicodePageLocations[par1] == null) {
            GSARFontRendererGlasgow.unicodePageLocations[par1] = new ResourceLocation(String.format("signalcraft:fonts/glasgow_unicode_page_00.png", par1));
        }
        return GSARFontRendererGlasgow.unicodePageLocations[par1];
    }
