...
public class GuiStativLightSignalsGSAR extends GuiScreen
{
    ...
    private final TileGSARStativLightSignals tileEStativLSig;
    private final String opLocStativ;
    private final String opNameStativ;
    public static final ResourceLocation pic1_HP;
    ...
    public GuiStativLightSignalsGSAR(final TileGSARStativLightSignals tileEntity) {
        ...
        this.tileEStativLSig = tileEntity;
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float par3) {
        ...
        this.mc.getTextureManager().bindTexture(pic1_HP);
    ...
    protected void actionPerformed(final GuiButton button) {
        if (button.enabled && button.id == 0) {
            this.tileEStativLSig.markDirty();
    ...
    public void onGuiClosed() {
        ...
        this.tileEStativLSig.setStationLabelStativ(this.editTextField_BS.getText());
        this.tileEStativLSig.setSignalLabelStativ(this.editTextField_Name.getText());
        Network.updateSignSignals(tileEStativLSig);
    }
    ...
    private void drawSignSignalGround() {
        ...
        final int k = this.mc.theWorld.getBlockMetadata(this.tileEStativLSig.xCoord, this.tileEStativLSig.yCoord, this.tileEStativLSig.zCoord);
        GL11.glPushMatrix();
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        final Block getBlockType = this.tileEStativLSig.getBlockType();
        if (getBlockType == SCItemBlocks.STATIV_LIGHT_HP.block) {
            final float f2 = this.tileEStativLSig.getBlockMetadata() * 360 / 16.0f;
        ...
        TileEntityRendererDispatcher.instance.renderTileEntityAt(this.tileEStativLSig, -0.5, -0.5, -0.5, 0.0f);
        GL11.glPopMatrix();
    }
    
    static {
        pic1_HP = new ResourceLocation("signalcraft:textures/gsar/gui/pics/pic1_HP.png");
    }
}
