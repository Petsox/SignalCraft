...
import signalcraft.entities.signals.lightSignals.azd70.TileAZDPr;
import signalcraft.gui.signals.lightSignals.GuiLightSignals;

public class GuiAZDPr extends GuiLightSignals {
    private final TileAZDPr thisTileE;
    public GuiAZDPr(TileAZDPr tileE) {
        super(tileE);
        thisTileE = tileE;
    }
