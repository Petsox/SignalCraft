...
public class ItemTreatedWoodPlate extends Item {

    public ItemTreatedWoodPlate(final String itemName) {
        this.setUnlocalizedName(itemName);
        this.setTextureName(SignalCraft.MOD_ID + ":treatedWoodPlate");
