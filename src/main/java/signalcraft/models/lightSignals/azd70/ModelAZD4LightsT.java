...
public class ModelAZD4LightsT extends ModelAZD implements IDwarf {
    private final IModelCustom modelLightSignals = ModelRegistry.AZD_4LIGHT_T.getModel();
