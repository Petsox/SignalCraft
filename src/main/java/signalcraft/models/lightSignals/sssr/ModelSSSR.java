...
public class ModelSSSR implements ILightSignalModel {
    public final ResourceLocation SSSR_MAIN_T = TextureRegistry.SSSR_MAIN_T.get();
    public final ResourceLocation SSSR_SKRINKA = TextureRegistry.SSSR_SKRINKA.get();
    public final ResourceLocation SSSR_PRUHY = TextureRegistry.SSSR_PRUHY.get();
    public final ResourceLocation SSSR_CISLA = TextureRegistry.SSSR_CISLA.get();
    public final ResourceLocation COCKY = TextureRegistry.COCKY.get();
    public final ResourceLocation COCKY_OFF = TextureRegistry.COCKY_OFF.get();
    public final ResourceLocation SSSR_AB_TERC = TextureRegistry.SSSR_AB_TERC.get();
    public final ResourceLocation SSSR_AB = TextureRegistry.SSSR_AB.get();
    public final ResourceLocation SSSR_IND_30 = TextureRegistry.SSSR_IND_30.get();
    public final ResourceLocation SSSR_IND_50 = TextureRegistry.SSSR_IND_50.get();
    public final ResourceLocation SSSR_MAIN = TextureRegistry.SSSR_MAIN.get();
     ...
     * substitute the raw signal string with the lamp it's actually rendered as;
     * {@code partNameFor} builds the OBJ part name for a (mapped) lamp key;
