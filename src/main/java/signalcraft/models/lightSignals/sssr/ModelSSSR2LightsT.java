...
public class ModelSSSR2LightsT extends ModelSSSR implements IDwarf {
    private final IModelCustom modelLightSignals = ModelRegistry.SSSR_2LIGHT_T.getModel();
    ...
    public void renderNavest(SignalState SigState, TileLightSignal tileSignal, String Pos, String PNLight) {
        renderNavestFaded(SigState, tileSignal, this.modelLightSignals, state -> state + "_trpaslik_pn");
    }
}
