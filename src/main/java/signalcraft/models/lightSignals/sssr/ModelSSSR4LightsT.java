...
public class ModelSSSR4LightsT extends ModelSSSR implements IDwarf {
    private final IModelCustom modelLightSignals = ModelRegistry.SSSR_4LIGHT_T.getModel();
    ...
    public void renderStoz(Boolean hasStripes, Boolean has3Stripes, String Pos, String SpeedSignText, String PNLight) {
        ...
        this.modelLightSignals.renderPart("trpaslik_4svet");
