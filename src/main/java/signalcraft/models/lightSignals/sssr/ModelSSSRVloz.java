...
public class ModelSSSRVloz extends ModelSSSR {
    private final IModelCustom modelLightSignals = ModelRegistry.SSSR_INSERTED.getModel();
    ...
    public void renderStoz(Boolean hasStripes, Boolean has3Stripes, String Pos, String SpeedSignText, String PNLight) {
        ...
        this.modelLightSignals.renderPart("stoz_vl_zaklad");
        Minecraft.getMinecraft().renderEngine.bindTexture(this.SSSR_CISLA);
        this.modelLightSignals.renderPart("stoz_vl_cisla");
        Minecraft.getMinecraft().renderEngine.bindTexture(this.SSSR_PRUHY);
        this.modelLightSignals.renderPart("stoz_vl_nater");
        Minecraft.getMinecraft().renderEngine.bindTexture(this.SSSR_MAIN);
        this.modelLightSignals.renderPart("stoz_vl_stozar");
