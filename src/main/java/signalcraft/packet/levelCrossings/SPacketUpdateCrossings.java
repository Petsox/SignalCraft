...
public class SPacketUpdateCrossings extends ServerPacket {
    ...
    public SPacketUpdateCrossings() {
        this.crossPropArr = new String[Consts.crossPropArrLenght];
    }

    public SPacketUpdateCrossings(final TileEntity tileEntity) {
        this.crossPropArr = new String[Consts.crossPropArrLenght];
        tileEntity.writeToNBT(this.mainNBTTC = new NBTTagCompound());
    }

    public SPacketUpdateCrossings(final int x, final int y, final int z) {
        this.crossPropArr = new String[Consts.crossPropArrLenght];
        this.xCoordinate = x;
        this.yCoordinate = y;
        this.zCoordinate = z;
    ...
    public void readPacketData(final PacketBuffer buffer) throws IOException {
        ...
        this.crossPropArr[21] = this.mainNBTTC.getString("Scale");
