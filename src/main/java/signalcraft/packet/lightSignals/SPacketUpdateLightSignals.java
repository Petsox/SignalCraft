...
public class SPacketUpdateLightSignals extends ServerPacket {
    ...
    public SPacketUpdateLightSignals() {
        this.lightSignalProperties = new String[Consts.lightPropArrLenght];
    }

    public SPacketUpdateLightSignals(final TileEntity tileEntity) {
        this.lightSignalProperties = new String[Consts.lightPropArrLenght];
        tileEntity.writeToNBT(this.mainNBTTC = new NBTTagCompound());
    }

    public SPacketUpdateLightSignals(final int x, final int y, final int z) {
        this.lightSignalProperties = new String[Consts.lightPropArrLenght];
        this.xCoordinate = x;
        this.yCoordinate = y;
        this.zCoordinate = z;
