...
public class SPacketUpdateSignSignals extends ServerPacket {
    ...
    public SPacketUpdateSignSignals() {
        this.signSignalProperties = new String[Consts.signPropArrLenght];
    }

    public SPacketUpdateSignSignals(final TileEntity tileEntity) {
        this.signSignalProperties = new String[Consts.signPropArrLenght];
        tileEntity.writeToNBT(this.mainNBTTC = new NBTTagCompound());
    }

    public SPacketUpdateSignSignals(final int x, final int y, final int z) {
        this.signSignalProperties = new String[Consts.signPropArrLenght];
        this.xCoordinate = x;
        this.yCoordinate = y;
        this.zCoordinate = z;
